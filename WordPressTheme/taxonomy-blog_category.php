...
<section class="p-sub-blog l-sub-blog">
  ...
  <div class="p-sub-blog__category p-category">
      <a class="p-category__link" href="<?php echo esc_url( home_url( '/blog/' ) ); ?>">ALL</a>
      <?php
      ...
      foreach ( $terms as $term ): ?>
        <a href="<?php echo get_term_link($term->slug,'blog_category'); ?>" class="p-category__link <?php if( $cat_slug === $term->slug ) { echo "p-category__link--current";} ?>"><?php echo $term->name; ?></a>
      <?php endforeach; ?>
    </div>
